...
INSERT INTO `clients` VALUES (1,'Wong','Bellvue','09042123545','wong@wong.wong');
...
INSERT INTO `items_depot` VALUES (1,'Slab A',1,'100',1,'2018-07-31 07:45:50','2019-09-01 06:00:00',10,1,1,699),(2,'Slab B',2,'100',2,'2018-08-01 07:45:00','2019-09-02 06:00:00',10,2,2,785),(3,'Slab C',3,'100',3,'2018-08-02 07:44:10','2019-09-03 06:00:00',10,3,3,599),(4,'Granite A',4,'100',4,'2018-08-03 07:43:20','2019-09-04 06:00:00',10,1,4,899),(5,'Granite B',5,'100',5,'2018-08-04 07:42:30','2019-09-05 06:00:00',10,2,5,1299),(6,'Granite C',6,'100',6,'2018-08-05 07:41:40','2019-09-06 06:00:00',10,3,1,1399),(7,'Granite D',7,'100',7,'2018-08-06 07:40:50','2019-09-07 06:00:00',10,1,2,1500),(8,'Granite E',8,'100',8,'2018-08-07 07:40:00','2019-09-08 06:00:00',10,2,3,250),(9,'Granite F',9,'100',9,'2018-08-08 07:39:10','2019-09-09 06:00:00',10,3,4,375),(10,'Granite G',10,'100',10,'2018-08-09 07:38:20','2019-09-10 06:00:00',10,1,5,800),(11,'Slab D',1,'100',1,'2018-08-10 07:37:30','2019-09-11 06:00:00',10,2,1,770),(12,'Slab E',2,'100',2,'2018-08-11 07:36:40','2019-09-12 06:00:00',10,3,2,650),(13,'Slab F',3,'100',3,'2018-08-12 07:35:50','2019-09-13 06:00:00',10,1,3,550),(14,'Slab G',4,'100',4,'2018-08-13 07:35:00','2019-09-14 06:00:00',10,2,4,890),(15,'Granite H',5,'100',5,'2018-08-14 07:34:10','2019-09-15 06:00:00',10,3,5,900),(16,'Granite I',6,'100',6,'2018-08-15 07:33:20','2019-09-16 06:00:00',10,1,1,345),(17,'Granite J',7,'100',7,'2018-08-16 07:32:30','2019-09-17 06:00:00',10,2,2,560),(18,'Granite K',8,'100',8,'2018-08-17 07:31:40','2019-09-18 06:00:00',10,3,3,450),(19,'Slab H',9,'100',9,'2018-08-18 07:30:50','2019-09-19 06:00:00',10,1,4,399),(20,'Slab I',10,'100',10,'2018-08-19 07:30:00','2019-09-20 06:00:00',10,2,5,2000);
...
INSERT INTO `order_details` VALUES (1,1,1,'Slab A',1000,42),(2,1,1,'Slab A',1000,55),(3,1,2,'Slab B',850,69),(4,1,3,'Slab C',700,124),(5,1,2,'Slab B',850,54),(6,1,4,'Granite A',200,152),(7,1,5,'Granite B',1000,550),(8,1,6,'Granite C',850,221),(9,1,7,'Granite D',700,172),(10,1,7,'Granite D',700,127);
...
INSERT INTO `orders` VALUES (1,1,'2018-01-31 12:30:00',NULL,NULL,1,NULL),(2,1,'2017-11-27 18:30:00',NULL,NULL,4,NULL),(3,1,'2018-07-13 13:40:00',NULL,NULL,3,NULL),(4,1,'2018-09-27 19:10:00',NULL,NULL,4,NULL),(5,1,'2018-05-16 21:20:00',NULL,NULL,2,NULL),(6,1,'2019-04-10 08:46:00',NULL,NULL,3,NULL),(7,1,'2019-01-12 10:39:00',NULL,NULL,3,NULL),(8,1,'2019-01-13 09:23:00',NULL,NULL,4,NULL),(9,1,'2019-01-12 07:25:00',NULL,NULL,2,NULL),(10,1,'2019-01-17 11:17:00',NULL,NULL,1,NULL);
...
INSERT INTO `ref_payment` VALUES (1,'Cash'),(2,'Credit'),(3,'Check'),(4,'Cash on Delivery');
...
INSERT INTO `sales_trading` VALUES (1,'Slab A',1000,NULL,NULL),(2,'Slab B',850,NULL,NULL),(3,'Slab C',700,NULL,NULL),(4,'Granite A',200,NULL,NULL),(5,'Granite B',1000,NULL,NULL);
/*!40000 ALTER TABLE `sales_trading` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `scheduledelivery`
--

DROP TABLE IF EXISTS `scheduledelivery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scheduledelivery` (
  ...
  `Truck Number` int(11) DEFAULT NULL,
  `Customer Name` varchar(45) DEFAULT NULL,
  `Destination` varchar(45) DEFAULT NULL,
  `Remarks` varchar(45) DEFAULT NULL,
  `Sales Agents` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `scheduledelivery`
--

LOCK TABLES `scheduledelivery` WRITE;
/*!40000 ALTER TABLE `scheduledelivery` DISABLE KEYS */;
/*!40000 ALTER TABLE `scheduledelivery` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-02-17 16:09:54
